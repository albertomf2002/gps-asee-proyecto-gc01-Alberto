...
import es.unex.giiis.asee.tiviclone.databinding.FragmentContactsBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            botonInsertar.setOnClickListener {
                val contacto = Contact(null, insertarTelefono.text.toString().toLong(), nombreContacto.text.toString())
